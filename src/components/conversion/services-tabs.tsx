...
const tabs: ServiceTab[] = [
  {
    ...
    mockup: {
      ...
      items: [
        {
          title: "Pre-approval",
          description: "Full financial position reviewed against lender policy",
          status: "Completed",
        },
        {
          title: "Property valuation",
          description: "Independent valuation ordered and confirmed",
          status: "Approved",
        },
        {
          title: "Loan structuring",
          description: "Rate, offset and repayment structure finalised",
          status: "Executed",
        },
        {
          title: "Unconditional approval",
          description: "Contracts ready to exchange with finance secured",
          status: "100% Complete",
          highlight: true,
        },
      ],
  ...
  },
  {
    ...
    mockup: {
      ...
      items: [
        {
          title: "Current loan reviewed",
          description: "Existing rate, fees and exit costs assessed",
          status: "Completed",
        },
        {
          title: "Rate comparison run",
          description: "Panel lenders compared on real, not advertised, rates",
          status: "Approved",
        },
        {
          title: "Equity assessed",
          description: "Available equity confirmed for cash-out or consolidation",
          status: "Executed",
        },
        {
          title: "New lender approved",
  ...
  },
  {
    ...
    mockup: {
      ...
      items: [
        {
          title: "Business financials reviewed",
          description: "Trading position and cash flow assessed",
          status: "Completed",
        },
        {
          title: "Security assessed",
          description: "Property and business security valued",
          status: "Approved",
        },
        {
          title: "Structure confirmed",
          description: "Trust, company or partnership structure verified",
          status: "Executed",
        },
        {
          title: "Facility approved",
          description: "Funds available for settlement or drawdown",
          status: "100% Complete",
          highlight: true,
        },
      ],
      ...
      items: [
        {
          ...
          description: "Commercial fleet or equipment identified",
          status: "Completed",
        },
        {
          title: "Credit assessed",
          description: "Lender pricing and terms verified",
          status: "Approved",
        },
        {
          title: "Documentation signed",
          description: "Contract executed and identity verified",
          status: "Executed",
        },
        {
          title: "Settlement complete",
          description: "Funds released directly to vendor",
          status: "100% Complete",
          highlight: true,
        },
      ],
